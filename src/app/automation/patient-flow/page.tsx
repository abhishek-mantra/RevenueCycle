...
import { UserCheck, CreditCard, MessageSquare, Mail, Send, CheckCircle2, Clock } from "lucide-react";
...
export default function PatientFlowPage({ embedInShell }: any) {
  ...
  const handleResend = (id: string) => {
    alert(`Re-sent pre-visit payment link for ${items.find((i) => i.id === id)?.patientName}!`);
  };
